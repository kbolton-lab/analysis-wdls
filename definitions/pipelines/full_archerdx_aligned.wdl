...
workflow archerdx {
    ...
    output {
        ...
        Array[File] tumor_per_target_coverage_metrics = collectPerTargetHsMetrics.per_target_coverage_metrics
        Array[File] tumor_per_target_hs_metrics = collectPerTargetHsMetrics.hs_metrics
        Array[File] tumor_per_base_coverage_metrics = collectPerBaseHsMetrics.per_base_coverage_metrics
